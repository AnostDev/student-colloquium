# Comparison of data-independentlocality-sensitive hashing (LSH) vs.data-dependent Locality-preservinghashing (LPH) for hashing-basedapproximate nearest neighbor search
